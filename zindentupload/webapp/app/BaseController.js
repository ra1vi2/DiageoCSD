sap.ui.define([
	...
	return Controller.extend("com.diageo.csd.indentuploadzindentupload.app.BaseController", {
		/**
		...
		onNavBack: function() {
			...
			if (sPreviousHash !== undefined) {
				...
				this.getRouter().navTo("indentupload", {}, true);
			}
		},
		...
		_getMessagePopover: function(oView) {
			...
			if (!this._pMessagePopover) {
				this._pMessagePopover = Fragment.load({
					id: oView.getId(),
					name: "com.diageo.csd.indentuploadzindentupload.fragments.MessagePopover"
